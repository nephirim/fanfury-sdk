...
// Profile with:
// /usr/local/go/bin/go test -benchmem -run=^$ github.com/persistenceOne/persistence-sdk/v2/ibctesting/furyapp -bench ^BenchmarkFullAppSimulation$ -Commit=true -cpuprofile cpu.out
