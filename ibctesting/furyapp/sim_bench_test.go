...
// Profile with:
// /usr/local/go/bin/go test -benchmem -run=^$ github.com/nephirim/fanfury-sdk/v2/ibctesting/furyapp -bench ^BenchmarkFullAppSimulation$ -Commit=true -cpuprofile cpu.out
