...
func request_QuerySrvr_Queries_0(ctx context.Context, marshaler runtime.Marshaler, client QuerySrvrClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_QuerySrvr_Queries_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func RegisterQuerySrvrHandlerServer(ctx context.Context, mux *runtime.ServeMux, server QuerySrvrServer) error {
	...
	mux.Handle("GET", pattern_QuerySrvr_Queries_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_QuerySrvr_Queries_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
// RegisterQuerySrvrHandlerFromEndpoint is same as RegisterQuerySrvrHandler but
...
func RegisterQuerySrvrHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterQuerySrvrHandler(ctx, mux, conn)
}
...
func RegisterQuerySrvrHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterQuerySrvrHandlerClient(ctx, mux, NewQuerySrvrClient(conn))
}

// RegisterQuerySrvrHandlerClient registers the http handlers for service QuerySrvr
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "QuerySrvrClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "QuerySrvrClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "QuerySrvrClient" to call the correct interceptors.
func RegisterQuerySrvrHandlerClient(ctx context.Context, mux *runtime.ServeMux, client QuerySrvrClient) error {
	...
	mux.Handle("GET", pattern_QuerySrvr_Queries_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_QuerySrvr_Queries_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_QuerySrvr_Queries_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"fanfury", "interchainquery", "v1beta1", "queries", "chain_id"}, "", runtime.AssumeColonVerbOpt(false)))
)

var (
	forward_QuerySrvr_Queries_0 = runtime.ForwardResponseMessage
)
