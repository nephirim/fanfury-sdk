...
func (suite *KeeperTestSuite) SetupTest() {
	app := furyapp.Setup(suite.T(), false)
	...
	suite.addrs = furyapp.AddTestAddrs(app, ctx, 2, sdk.NewInt(1000000000))
	suite.valAddrs = furyapp.ConvertAddrsToValAddrs(suite.addrs)
}
