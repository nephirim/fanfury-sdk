...
func (k msgServer) CreateValidator(goCtx context.Context, msg *types.MsgCreateValidator) (*types.MsgCreateValidatorResponse, error) {
	...
	if msg.Commission.Rate.LT(k.MinCommissionRate(ctx)) {
		return nil, errors.Wrapf(sdkstaking.ErrCommissionLTMinRate, "cannot set validator commission to less than minimum rate of %s", k.MinCommissionRate(ctx))
	}
...
func (k msgServer) Delegate(goCtx context.Context, msg *types.MsgDelegate) (*types.MsgDelegateResponse, error) {
	...
	newShares, err := k.Keeper.Delegate(ctx, delegatorAddress, tokens, sdkstaking.Unbonded, validator, true)
	if err != nil {
		return nil, err
	}
