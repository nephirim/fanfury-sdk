...
```bash
furyd query staking delegation [delegator-addr] [validator-addr] [flags]
```

Example:

```bash
furyd query staking delegation cosmos1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p cosmosvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
```
...
```bash
furyd query staking delegations [delegator-addr] [flags]
```

Example:

```bash
furyd query staking delegations cosmos1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p
```
...
```bash
furyd query staking delegations-to [validator-addr] [flags]
```

Example:

```bash
furyd query staking delegations-to cosmosvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
```
...
```bash
furyd query staking historical-info [height] [flags]
```

Example:

```bash
furyd query staking historical-info 10
```
...
```bash
furyd query staking params [flags]
```

Example:

```bash
furyd query staking params
```
...
```bash
furyd q staking pool [flags]
```

Example:

```bash
furyd q staking pool
```
...
```bash
furyd query staking redelegation [delegator-addr] [src-validator-addr] [dst-validator-addr] [flags]
```

Example:

```bash
furyd query staking redelegation cosmos1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p cosmosvaloper1l2rsakp388kuv9k8qzq6lrm9taddae7fpx59wm cosmosvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
```
...
```bash
furyd query staking redelegations [delegator-addr] [flags]
```

Example:

```bash
furyd query staking redelegation cosmos1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p
```
...
```bash
furyd query staking redelegations-from [validator-addr] [flags]
```

Example:

```bash
furyd query staking redelegations-from cosmosvaloper1y4rzzrgl66eyhzt6gse2k7ej3zgwmngeleucjy
```
...
```bash
furyd query staking unbonding-delegation [delegator-addr] [validator-addr] [flags]
```

Example:

```bash
furyd query staking unbonding-delegation cosmos1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p cosmosvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
```
...
```bash
furyd query staking unbonding-delegations [delegator-addr] [flags]
```

Example:

```bash
furyd query staking unbonding-delegations cosmos1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p
```
...
```bash
furyd query staking unbonding-delegations-from [validator-addr] [flags]
```

Example:

```bash
furyd query staking unbonding-delegations-from cosmosvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
```
...
```bash
furyd query staking validator [validator-addr] [flags]
```

Example:

```bash
furyd query staking validator cosmosvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
```
...
```bash
furyd query staking validators [flags]
```

Example:

```bash
furyd query staking validators
```
...
```bash
furyd tx staking create-validator [flags]
```
...
```bash
furyd tx staking delegate [validator-addr] [amount] [flags]
```

Example:

```bash
furyd tx staking delegate cosmosvaloper1l2rsakp388kuv9k8qzq6lrm9taddae7fpx59wm 1000stake --from mykey
```
...
```bash
furyd tx staking edit-validator [flags]
```

Example:

```bash
furyd tx staking edit-validator --moniker "new_moniker_name" --website "new_webiste_url" --from mykey
```
...
```bash
furyd tx staking redelegate [src-validator-addr] [dst-validator-addr] [amount] [flags]
```

Example:

```bash
furyd tx staking redelegate cosmosvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj cosmosvaloper1l2rsakp388kuv9k8qzq6lrm9taddae7fpx59wm 100stake --from mykey
```
...
```bash
furyd tx staking unbond [validator-addr] [amount] [flags]
```

Example:

```bash
furyd tx staking unbond cosmosvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj 100stake --from mykey
```
#### cancel unbond 
...
Usage:
```bash
furyd tx staking cancel-unbond [validator-addr] [amount] [creation-height]
```

Example:
```bash
furyd tx staking cancel-unbond cosmosvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj 100stake 123123 --from mykey
```
